...
class PrerequisitesHelper():
    ...
    def must_equal(self, attr, value, code=Status.HTTP_417_EXPECTATION_FAILED):
    ...
    def must_one(self, query, code=Status.HTTP_404_NOT_FOUND):
        try:
            ...
            raise ClientError('object not found', Status.HTTP_404_NOT_FOUND)
    ...
    def must_mine(self, user, model, foreign_value=None):
        '''
